...
function updateTranslations() {
    ...
    document.querySelector('.quick-connection__label-password').textContent = i18next.t('quick-connection-label-password');
    const quickConnectionInputPassword = document.querySelector('.quick-connection__input-password');
    quickConnectionInputPassword.placeholder = i18next.t('quick-connection-input-password');
            ...
            resources: {
                kz: {
                    translation: {
                        ...
                        "about-company-title-social-networks": "Әлеуметтік желі",
